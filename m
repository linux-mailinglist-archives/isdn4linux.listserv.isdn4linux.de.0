...
Received: from listserv.isdn4linux.de (listserv.isdn4linux.de [IPv6:2001:8d8:912:a9e:ab05:ddc6:eb4a:1ffd])
	by mail.lfdr.de (Postfix) with ESMTPS id 53DA032899
	for <lists+isdn4linux@lfdr.de>; Mon,  3 Jun 2019 08:35:29 +0200 (CEST)
Received: from listserv.isdn4linux.de (localhost [IPv6:0:0:0:0:0:0:0:1])
	by listserv.isdn4linux.de (8.15.2/8.15.2) with ESMTP id x536VxHx017250;
	Mon, 3 Jun 2019 08:32:29 +0200
X-Virus-Status: Clean
X-Virus-Scanned: clamav-milter 0.101.2 at listserv.isdn4linux.de
Received: from mail-qk1-f196.google.com (mail-qk1-f196.google.com
 [209.85.222.196])
 by listserv.isdn4linux.de (8.15.2/8.15.2) with ESMTPS id x4VCXA7h028259
 (version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=FAIL)
 for <isdn4linux@listserv.isdn4linux.de>; Fri, 31 May 2019 14:33:11 +0200
X-Virus-Status: Clean
X-Virus-Scanned: clamav-milter 0.101.2 at listserv.isdn4linux.de
Received: by mail-qk1-f196.google.com with SMTP id s22so4071934qkj.12
 for <isdn4linux@listserv.isdn4linux.de>; Fri, 31 May 2019 05:33:10 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:mime-version:from:date:message-id:subject:to:cc;
 bh=tr1mxKsxyqiyw16MKVtN4SogXZGxHYJtMdTR2Kg/Wm8=;
 b=
X-Gm-Message-State: APjAAAXVfd+asXSe4vxs4sFmDE7gTHse1ZcTcTPqCKgGv/UUUv2hONI4
 GiCqkMqk8Bv385QFIFCRaFZPi9704ec7L1hTIto=
...
X-Greylist: Sender passed SPF test, not delayed by milter-greylist-4.6.2 (listserv.isdn4linux.de [IPv6:::1]); Mon, 03 Jun 2019 08:32:51 +0200 (CEST)
X-Greylist: Sender passed SPF test, not delayed by milter-greylist-4.6.2
 (listserv.isdn4linux.de [82.165.11.104]);
 Fri, 31 May 2019 14:33:11 +0200 (CEST)
